...
$page_sub     = 'Governing documents, bylaws and operational policies of Braemeg SACCO.';
$breadcrumbs  = [
...
$sidebar_items = [
    ...
    ['label' => 'Policies & Bylaws', 'href' => 'policies.php', 'active' => true],
    ['label' => 'Annual Reports',    'href' => 'annual-reports.php'],
    ['label' => 'FAQs',              'href' => 'faqs.php'],
];

/* Fetch from DB if table exists */
$policies_qry = $dbc->prepare(
    "SELECT * FROM tbl_downloads WHERE published='1' AND category='Policies' ORDER BY title ASC"
);
$policies_qry->execute();
$policies = $policies_qry->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="downloads-list">
                        ...
                        <div class="download-item">
                            ...
                            <div class="download-item__info">
                                <h4 class="download-item__title"><?php echo htmlspecialchars($pol['title']); ?></h4>
                                <?php if (!empty($pol['description'])): ?>
                                <p class="download-item__desc"><?php echo htmlspecialchars($pol['description']); ?></p>
                                <?php endif; ?>
                            </div>
                            <a href="../files/<?php echo htmlspecialchars($pol['filePath']); ?>"
